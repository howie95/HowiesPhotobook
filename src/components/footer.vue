    ...
    <footer>
        <div class="foot-bts" v-if="!isTop">
            <ul>
                ...
                <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26.21 24.5"><path d="M16,13.72,8.1,27.39A1.72,1.72,0,0,1,5.74,28l-2-1.14a1.74,1.74,0,0,1-.64-2.36l8.68-15H5.23A1.72,1.72,0,0,1,3.5,7.77V5.48A1.72,1.72,0,0,1,5.23,3.75H26.77A1.72,1.72,0,0,1,28.5,5.48V7.77A1.72,1.72,0,0,1,26.77,9.5H20.2l8.68,15a1.74,1.74,0,0,1-.64,2.36l-2,1.14a1.72,1.72,0,0,1-2.36-.63Z" transform="translate(-2.89 -3.75)"/></svg></li>
            </ul>
        </div>
    </footer>
</template>
